...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-08-2024 a las 06:11:49
...
CREATE TABLE `tbl_keypress` (
  `id` int(11) NOT NULL,
  `base64Img` varchar(500) NOT NULL,
  `Key_number` int(11) NOT NULL,
  `KeyDescripcion` varchar(50) NOT NULL
...
(16, 'SECRE', 5.00, 'Empleado'),
(18, 'admin', 5.00, 'Empleado');
...
CREATE TABLE `tbl_remplazos` (
  ...
  `Rem_from` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Rem_to` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
--
ALTER TABLE `tbl_detallediaempleado`
  MODIFY `id_DDE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `tbl_detalleposempleado`
--
ALTER TABLE `tbl_detalleposempleado`
  MODIFY `id_DetallePosEmp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_posicion`
  MODIFY `id_Posicion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `tbl_remplazos`
--
ALTER TABLE `tbl_remplazos`
  MODIFY `id_Rem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
